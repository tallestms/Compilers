...
%%
PROG:  token_algoritmo token_identificador token_pontov {in_logico = 0 ; in_comparacao = 0; in_condicional = 0; currentRelationPos = 0; isMatrix = 0; argumentNumber = 0; strcpy(identifiers, "\0");} BLOCO_FUNCOES BLOCO_VARIAVEIS token_inicio BLOCO token_fim  
{
...
token_pontov {in_logico = 0 ; in_comparacao = 0; in_condicional = 0;currentRelationPos = 0; isMatrix = 0; argumentNumber = 0; strcpy(identifiers, "\0");} BLOCO_VARIAVEIS token_inicio BLOCO token_fim 
{
 // verifyMatrix(hashVariables);
 verifyUsed(hashVariables);
}
...
| /*Empty*/;
EXPR: SIEXPR { swapoutTresDois(); in_logico = 0;}
